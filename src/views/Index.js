                      ...
                      <Col className="fluid">
                        ...
                        >
                          <CardHeader
                            ...
                            className="zoom"
                          >
                            <h3 style={{ paddingTop: "18px", color:"" }}><b>Implementación</b></h3>
                          </CardHeader>
                      ...
                      <Col className="fluid">
                        ...
                        >
                          <CardHeader
                            ...
                            className="zoom"
                          >
                            <h3 style={{ paddingTop: "18px",color:"" }}><b>RRHH</b></h3>
                          </CardHeader>
                      ...
                      <Col className="fluid">
                        ...
                        >
                          ...
                          <CardHeader
                            ...
                            className="zoom"
                          >
                            <h3 style={{ paddingTop: "18px",color:"" }}><b>Capacitación</b></h3>
                          </CardHeader>
                        </Card>
                      </Col>
                      ...
                      <Col className="fluid">
                        ...
                        >
                          <CardHeader
                            ...
                            className="zoom"
                          >
                            <h3 style={{ paddingTop: "18px",color:"" }}><b>Comunicación</b></h3>
                          </CardHeader>
                        </Card>
                      </Col>
                    </Row>
                      ...
                      <Col className="fluid">
                        ...
                        >
                          <CardHeader
                            ...
                            className="zoom"
                          >
                            <h3 style={{ paddingTop: "18px", color:"" }}><b>Operación</b></h3>
                          </CardHeader>
                        </Card>
                      </Col>
                      ...
                      <Col className="fluid">
                        ...
                        >
                          <CardHeader
                            ...
                            className="zoom"
                          >
                            <h3 style={{ paddingTop: "18px", color:"" }}><b>TI</b></h3>
                          </CardHeader>
                        </Card>
                      </Col>
                      ...
                      <Col className="fluid">
                        ...
                        >
                          <CardHeader
                            ...
                            className="zoom"
                          >
                            <h3 style={{ paddingTop: "18px", color:"" }}><b>Command Center</b></h3>
                          </CardHeader>
                        </Card>
                      </Col>
                      ...
                      <Col className="fluid">
                        ...
                        >
                          <CardHeader
                            ...
                            className="zoom"
                          >
                            <h3 style={{ paddingTop: "18px", color:"" }}><b>Calidad</b></h3>
                          </CardHeader>
                        </Card>
                      </Col>
                      ...
                      <Col className="fluid">
                        ...
                        >
                          <CardHeader
                            ...
                            className="zoom"
                          >
                            <h3 style={{ paddingTop: "18px", color:"" }}><b>Procesos</b></h3>
                          </CardHeader>
